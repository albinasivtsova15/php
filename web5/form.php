  ...
  <div class="form-head">
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <input type="radio" id="radio4" name="limbs" value="4" <?php if ($values['limbs'] == '4') {print 'checked';} ?>>
            <label for="radio4">4</label>
            <input type="radio" id="radio8" name="limbs" value="6" <?php if ($values['limbs'] == '6') {print 'checked';} ?>>
            <label for="radio8">6</label>
          </li>
        </ul>
      </div>
      <div class="form-item">
        <p <?php if ($errors['abilities1'] || $errors['abilities2']) {print 'class="error"';} ?>>Укажите сверхспособность:</p>
    ...
    <div class="send">
      <div class="contract">
        ...
        <label for="checkboxContract" <?php if ($errors['checkboxContract']) {print 'class="error"';} ?>>С правилами ознакомлен.</label>
