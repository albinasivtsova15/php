            ...
            <?php
                foreach ($values as $value) {
                    echo    '<tr>
                            ...
                            <td>
                                <input class="input" name="name'.$value['application_id'].'" value="'; print(htmlspecialchars($value['name'])); echo '">
                            </td>
                            <td>
                    ...
                    echo        '</select>
                            ...
                            <td>
                                <div class="column-item">
                                    <input type="radio" id="radioRight'.$value['application_id'].'" name="limbs'.$value['application_id'].'" value="2" '; if ($value['limbs'] == '2') echo 'checked'; echo '>
                                    <label for="radioRight'.$value['application_id'].'">2</label>
                                </div>
                                <div class="column-item">
                                    <input type="radio" id="radioLeft'.$value['application_id'].'" name="limbs'.$value['application_id'].'" value="4" '; if ($value['limbs'] == '4') echo 'checked'; echo '>
                                    <label for="radioLeft'.$value['application_id'].'">4</label>
                                </div>
                                <div class="column-item">
                                    <input type="radio" id="radioLeft'.$value['application_id'].'" name="limbs'.$value['application_id'].'" value="6" '; if ($value['limbs'] == '6') echo 'checked'; echo '>
                                    <label for="radioLeft'.$value['application_id'].'">6</label>
                                </div>
                            </td>';
                    ...
                    echo    '<td class="abilities">
                            ...
                            <td>
                                <textarea name="biography'.$value['application_id'].'" id="" cols="30" rows="4" maxlength="128">'; print htmlspecialchars($value['biography']); echo '</textarea>
                            </td>
                            <td>
                                <div class="column-item">
